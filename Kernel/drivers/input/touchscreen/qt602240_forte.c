...
void qt_Power_Config_Init(void)
{
    ...
    power_config.idleacqint = 48;  //64;SM:
...
{
#ifdef CONFIG_S5PV210_GARNETT_DELTA || if defined CONFIG_MACH_FORTE
...
void qt_Multitouchscreen_Init(void)
{
    ...
    touchscreen_config.xsize = 16;  //9;
    touchscreen_config.ysize = 11;

    touchscreen_config.akscfg = 0;
    touchscreen_config.blen = 16;  //0x21;
...
#endif
    touchscreen_config.tchdi = 2;
    touchscreen_config.orient = 1; //qt602240->pdata->orient;
    ...
    touchscreen_config.amphyst = 10;
    touchscreen_config.xrange = 479; //qt602240->pdata->x_size;
    touchscreen_config.yrange = 319; //qt602240->pdata->y_size;
    touchscreen_config.xloclip = 0;
    touchscreen_config.xhiclip = 0;
    touchscreen_config.yloclip = 0;
    touchscreen_config.yhiclip = 0;
...
{
    keyarray_config.ctrl = 1;//0;
    keyarray_config.xorigin = 0;
    keyarray_config.yorigin = 11;//0;
    keyarray_config.xsize = 1;//0;
    keyarray_config.ysize = 3;//0;
    keyarray_config.akscfg = 0;
    keyarray_config.blen = 0;
    keyarray_config.tchthr = 255;//0;
...
#else	
		touchscreen_config.tchthr = 55;  //70;
...
/*end*/
    ...
    input_set_abs_params(qt602240->input_dev, ABS_X, 0, 319, 0, 0);
    input_set_abs_params(qt602240->input_dev, ABS_Y, 0, 479, 0, 0);
#ifdef _SUPPORT_MULTITOUCH_
    input_set_abs_params(qt602240->input_dev, ABS_MT_POSITION_X, 0, 319, 0, 0);
    input_set_abs_params(qt602240->input_dev, ABS_MT_POSITION_Y, 0, 479, 0, 0);
#endif
