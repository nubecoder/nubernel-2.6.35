...
void wm8994_record_main_mic(struct snd_soc_codec *codec)
{
	...
	if(wm8994->input_source == RECOGNITION)
	{
        ...
        wm8994_write(codec, 0x0400, 0x00EF);    // AIF1 ADC1 Left Volume   // 3.75 ==> 6.375
        wm8994_write(codec, 0x0401, 0x00EF);    // AIF1 ADC1 Right Volume  // 3.75 ==> 6.375
		wm8994_write(codec, 0x0410, 0x1800);	// AIF1 DRC 1(5)
	...
	else
	{
       ...
       audio_ctrl_mic_bias_gpio(wm8994->pdata, 1);
        ...
        wm8994_write(codec, 0x0018, 0x0117); //MBhskim_ED12 - H/W request MIC Gain
...
void wm8994_record_bluetooth(struct snd_soc_codec *codec)
{
	...
	if (!(wm8994->codec_state & CALL_ACTIVE)) {
		...
		val |= (WM8994_AIF2ADCL_ENA | WM8994_AIF2ADCR_ENA | WM8994_AIF1ADC1L_ENA | WM8994_AIF1ADC1R_ENA);
		wm8994_write(codec, WM8994_POWER_MANAGEMENT_4 , val);
...
void wm8994_set_playback_headset(struct snd_soc_codec *codec)
{
	...
	{
		wm8994_write(codec, 0x001C, 0x0175);	// Left Output Volume
		wm8994_write(codec, 0x001D, 0x0175);	// Right Output Volume
		wm8994_write(codec, 0x0020, 0x0179);	// Left OPGA Volume
		wm8994_write(codec, 0x0021, 0x0179);	// Right OPGA Volume
	}
	wm8994_write(codec, 0x0402, 0x01C0);	// AIF1 DAC1 Left Volume
...
void wm8994_set_playback_speaker_headset(struct snd_soc_codec *codec)
{
	...
	{
		wm8994_write(codec, 0x001C, 0x0165);	// Left Output Volume
		wm8994_write(codec, 0x001D, 0x0165);	// Right Output Volume
	}
	wm8994_write(codec, 0x0055, 0x03E0);	// DC Servo 2
...
void wm8994_set_voicecall_headset(struct snd_soc_codec *codec)
{
	...
	{
		wm8994_write(codec, 0x001A, 0x0112/*0x0112*/);	  // Right Line Input 1&2 Volume
